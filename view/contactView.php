...
<div class="container" style="margin-bottom: 100px">
    ...
    <div class="col">
        <div class="col">            
            <img  id="whatsapp" src="public/img/whatsapp.jpg" width="50" height="50" alt="Card image cap">
            <label for="whatsapp" class="contactLabels"> +506 7245 1637</label>          
        </div>      
        <div class="col">            
            <img  id="gmail" src="public/img/gmail.png" width="50" height="50" alt="Card image cap">
        ...
        <div class="col">
            <img  id="instagram" src="public/img/instagram.jpg" width="50" height="50" alt="Card image cap">
            <label for="instagram" class="contactLabels"> lacteos.herencia</label>
        </div>    
        <div class="col">
            <img  id="facebook" src="public/img/facebook.jpg" width="50" height="50" alt="Card image cap">
